...
|[CWE-664: Improper Control of a Resource Through its Lifetime](https://cwe.mitre.org/data/definitions/664.html)<img width=520/>|Prominent CVE <img width=80/>|
|:-----------------------------------------------------------------------------------------------------------------------------------------------|:----|
...
|[CWE-693: Protection Mechanism Failure](https://cwe.mitre.org/data/definitions/693.html)<img width=520/>|Prominent CVE<img width=80/>|
|:----------------------------------------------------------------|:----|
...
|[CWE-703: Improper Check or Handling of Exceptional Conditions](https://cwe.mitre.org/data/definitions/703.html)<img width=420/>|Prominent CVE <img width=80/>|
|:----------------------------------------------------------------|:----|
...
|[CWE-707: Improper Neutralization](https://cwe.mitre.org/data/definitions/707.html)<img width=520/>|Prominent CVE<img width=80/>|
|:----------------------------------------------------------------|:----|
...
|[CWE-710: Improper Adherence to Coding Standards](https://cwe.mitre.org/data/definitions/710.html)<img width=520/>|Prominent CVE<img width=80/>|
|:----------------------------------------------------------------|:----|
